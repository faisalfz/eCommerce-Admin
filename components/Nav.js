...
const Nav = () => {
  ...
  const activeLink = 'flex items-center gap-1 pr-8 p-2 rounded-l-xl bg-white text-blue-900'
  const inActiveLink = 'flex items-center gap-1 pr-8 p-2 hover:bg-white hover:text-blue-900'
